    ...
    >
      ...
      >
        ...
        <p className="mb-4 text-sm text-center max-w-xl mx-auto">
          Укажите параметры старой и новой шины, а также дисков. Калькулятор рассчитает разницу в диаметре, окружности,
          клиренсе, а также смещение относительно подвески и крыла автомобиля.  
          <br />
          Вы получите данные о влиянии на спидометр, дорожный просвет и рисках при установке.  
          ⚠️ Все результаты предварительные и носят справочный характер — для точной совместимости сверяйтесь с документацией производителя.
        </p>
